...
const _PLACES: Place[] = [
  ...
  { id: 'p05', slug: 'house-of-chappaz', name: 'House of Chappaz', summary: 'Avant-garde gallery focused on the local Barcelona scene, founded 2021. Upcoming: Vicky Uslé from April 17.', address: 'Carrer del Duc, 4', neighborhood: 'Gòtic', city: 'Barcelona', categories: ['art-gallery'], primaryDomain: 'fungi', tags: ['avant-garde', 'local-artists'], website: 'https://houseofchappaz.com/' },
  { id: 'p06', slug: 'load-gallery', name: 'Load Gallery', summary: 'Digital and physical art gallery. Current exhibition: "Desilence" by Paramnésico through April 25, 2026.', address: 'Carrer de Ferlandina, 17', neighborhood: 'Raval', city: 'Barcelona', categories: ['art-gallery'], primaryDomain: 'fungi', tags: ['digital-art', 'generative', 'new-media'], website: 'https://load-gallery.com/' },
  ...
  { id: 'p33', slug: 'angels-barcelona', name: 'àngels barcelona', summary: 'Long-running contemporary programme with bold installations and a focus on conceptual and time-based work.', address: 'Carrer del Pintor Fortuny, 27', neighborhood: 'Gòtic', city: 'Barcelona', categories: ['art-gallery'], primaryDomain: 'fungi', tags: ['installation', 'conceptual', 'time-based'], website: 'https://angelsbarcelona.com/' },
  ...
  { id: 'p38', slug: 'oxford-house-barcelona', name: 'Oxford House Barcelona', summary: 'Language school since 1998: English, Spanish for foreigners, Catalan, teacher training, and exam prep groups.', address: 'Carrer de Diputació, 279', neighborhood: 'Eixample', city: 'Barcelona', categories: ['workshop'], primaryDomain: 'fungi', tags: ['languages', 'english', 'spanish', 'courses'], website: 'https://oxfordhousebcn.com/' },
  ...
  { id: 'p56', slug: 'cccb', name: 'CCCB', summary: 'Centre de Cultura Contemporània de Barcelona: exhibitions, festivals, debates, and urban-culture programming facing the Raval.', address: 'Carrer de Montalegre, 5', neighborhood: 'Raval', city: 'Barcelona', categories: ['conference', 'workshop'], primaryDomain: 'fungi', tags: ['exhibitions', 'festivals', 'urban-culture'], website: 'https://www.cccb.org/' },
  ...
  { id: 'p62', slug: 'galeria-trama', name: 'Galeria Trama', summary: 'Contemporary gallery with a focus on conceptual and material practices — solo projects and curated dialogues in the old city.', address: 'Carrer dels Banys Nous, 22', neighborhood: 'Gòtic', city: 'Barcelona', categories: ['art-gallery'], primaryDomain: 'fungi', tags: ['conceptual', 'solo-shows', 'old-city'] },
  ...
  { id: 'p83', slug: 'espai-egg', name: 'Espai EGG', summary: 'Independent culture lab in the Riereta — comics, illustration residencies, zine fairs, and hands-on narrative workshops.', address: 'Carrer de la Riereta, 15', neighborhood: 'Raval', city: 'Barcelona', categories: ['workshop', 'art-gallery'], primaryDomain: 'fungi', tags: ['comics', 'zines', 'illustration'], website: 'https://www.espaiegg.net/' },
  { id: 'p84', slug: 'arts-santa-monica', name: 'Arts Santa Mònica', summary: 'La Rambla arts centre for experimental creation — exhibitions, labs, and public programmes where craft meets new media.', address: 'La Rambla, 7', neighborhood: 'Raval', city: 'Barcelona', categories: ['art-gallery', 'workshop'], primaryDomain: 'fungi', tags: ['experimental', 'rambla', 'labs'], website: 'https://artssantamonica.cat/' },
  ...
  { id: 'p95', slug: 'la-central-libreria', name: 'La Central', summary: 'Landmark bookstore on Mallorca — three floors of fiction, essays, and events: readings, launches, and small-group seminars.', address: 'Carrer de Mallorca, 237', neighborhood: 'Eixample', city: 'Barcelona', categories: ['shop', 'workshop'], primaryDomain: 'earth', tags: ['books', 'readings', 'essays'], website: 'https://www.lacentral.com/' },
...
const _SEED_EVENTS_CORE: CityEvent[] = [
  ...
  { id: 'e04', slug: 'desilence-paramnésico', title: '"Desilence" by Paramnésico', summary: 'Digital art exhibition at Load Gallery exploring sound, silence, and generative visuals.', startsAt: '2026-03-05T11:00', endsAt: '2026-04-25T19:00', placeId: 'p06', placeName: 'Load Gallery', primaryDomain: 'fungi', tags: ['digital-art', 'generative', 'exhibition'] },
  ...
  { id: 'e10', slug: 'fab-lab-open-day', title: 'Fab Lab Open Day', summary: 'Tour the fabrication facilities, meet the ENSEMBLE network, and try hands-on biotech demos.', startsAt: '2026-04-12T10:00', endsAt: '2026-04-12T17:00', placeId: 'p19', placeName: 'Fab Lab Barcelona', primaryDomain: 'fungi', tags: ['makerspace', 'open-day', 'biotech'] },
...
export const SEED_CREATORS: Creator[] = [
  ...
  { id: 'c05', slug: 'aina-vilar', displayName: 'Aina Vilar', bio: 'Bio-artist growing living sculptures. Resident at ESPRONCEDA Institute.', city: 'Barcelona', primaryDomain: 'plants' },
  ...
  { id: 'c14', slug: 'eli-canudas', displayName: 'Eli Canudas', bio: 'Performance and installation artist based at Hangar; builds wearable sets from salvaged industrial textiles.', city: 'Barcelona', primaryDomain: 'animals' },
];
...
function matchesDomain(
  ...
  if (normalizeDomain(primary) === needle) return true;
  return secondary?.some((s) => normalizeDomain(s) === needle) ?? false;
}

export function getPlacesByDomain(domain: string): Place[] {
  return SEED_PLACES.filter((p) =>
    matchesDomain(p.primaryDomain, p.secondaryDomains, domain),
  );
}

export function getEventsByDomain(domain: string): CityEvent[] {
  return SEED_EVENTS.filter((e) =>
    matchesDomain(e.primaryDomain, e.secondaryDomains, domain),
  );
}

export function getCreatorsByDomain(domain: string): Creator[] {
  return SEED_CREATORS.filter((c) =>
    matchesDomain(c.primaryDomain, c.secondaryDomains, domain),
  );
}
